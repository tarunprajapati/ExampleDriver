...
public class CustomerSupport extends BaseFragment{
	
	public static final String TAG = Constants.CustomerSupport;

	public CustomerSupport() {

	}

	public static CustomerSupport newInstance(Bundle bundle) {
